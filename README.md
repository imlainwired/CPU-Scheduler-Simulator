...
![Alt Text](https://github.com/imlainwired/CPU-Scheduler-Simulator/blob/main/images/image_1.png)
...
![Alt Text](https://github.com/imlainwired/CPU-Scheduler-Simulator/blob/main/images/image_2.png)

## ⚙️ Features:
1. Step-by-step **simulation bar** that visually represents process execution.

![Alt Text](https://github.com/imlainwired/CPU-Scheduler-Simulator/blob/main/images/image_3.png)

![Alt Text](https://github.com/imlainwired/CPU-Scheduler-Simulator/blob/main/images/image_5.png)

3. **Clean and cool console output** for better readability.
4. A **final summary table** displayed at the end of the simulation.

![Alt Text](https://github.com/imlainwired/CPU-Scheduler-Simulator/blob/main/images/image_4.png)
